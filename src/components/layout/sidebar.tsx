...
export function Sidebar({ role }: SidebarProps) {
  ...
  return (
    <>
        ...
        <div className="mt-auto border-t p-4">
          <div className="rounded-lg bg-green-50 p-4">
            ...
            <button 
              ...
              className="w-full text-xs font-semibold bg-white text-green-700 border border-green-200 rounded py-1.5 hover:bg-green-100 transition-colors"
            >
              Chat CS
            </button>
          </div>
      ...
      {/* Modal CS */}
      <ChatCSModal isOpen={isChatOpen} onOpenChange={setIsChatOpen} />
    </>
  );
}
